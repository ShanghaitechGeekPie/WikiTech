...
published: true
date: 2026-07-11T10:48:28.588Z
tags: fresh
editor: markdown
dateCreated: 2026-05-13T02:42:15.728Z
---
...
- 26 级本科生群：`10******10`（尚未开始，耐心等待）

新生群**仅允许学生本人加入**，请提醒你的家长避免给管理员带来额外的工作，申请时请注明自己的地区与姓名。
...
- 蚊帐或遮光帘（本科生宿舍部分有遗留的挂钩，研究生宿舍还需要同时采购支撑杆/架）

- 排插（本科生宿舍每个床位下配备1~2个国标壁插，务必购买优质排插以避免安全隐患）
...
上科大在新生入学时不会配发来自任何运营商的电话卡，在报到时，三大电信运营商均会前来设摊，提供的手机卡自带校园套餐资费一般优惠程度非常大，且在校外无法获得，需要的同学记得抓住报到时的机会购买新的上海本地手机号。
...
目前三大运营商在学校室外都有良好的 4G/5G 信号，学校在室内已经基本全范围覆盖 SSID 为 `ShanghaiTech`、`ShanghaiTech-Guest` 和 `eduroam` 等可用 Wi-Fi，配置方法详见 [Wi-Fi 配置指南](/zh/skills.md#wi-fi有线网认证指南)。
...
- **储蓄账户**：就是普通的活期储蓄存款，可用于网银，搭乘公交/地铁（非公交卡，上海地铁支持刷银行卡进站）等支付用途（需自行前往上行网点开通网银业务）；
...
- **校园一卡通账户**：用于校内消费，如食堂就餐等，也属于圈存性质，可以使用现金充值或者储蓄账户余额转存。校园一卡通可通过微信、支付宝、现金、银行卡（银校转账/自助圈存机）等方式充值。
  ...
  - **微信充值**：
    ...
    - 使用 `上科大CampUs` （ID:`shanghaitech2013`）微信公众号，选择 `CampUs-一卡通充值` 绑定校园卡，并提交：
      - 姓名：个人姓名；
      - 学号/卡号：办理校园卡的学工号；
      - 查询密码：校园卡查询密码（非银行卡和 `egate` 密码），初始密码为123456；
    - 或关注 `完美校园` 公众号（ID: `wanxiao-app`），使用流程类似。
...
![campus-card.png](/zh/fresh/campus-card.png)
...
![campus-card-introduction-1.png](/zh/fresh/campus-card-introduction-1.png)

![campus-card-introduction-2.png](/zh/fresh/campus-card-introduction-2.png)

![campus-card-introduction-3.png](/zh/fresh/campus-card-introduction-3.png)

![campus-card-introduction-4.png](/zh/fresh/campus-card-introduction-4.png)
